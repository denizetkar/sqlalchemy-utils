...
class DropMaterializedViewOp(MigrateOperation):
    ...
    def drop_materialized_view(
        ...
        *,
        ...
        .. note::
           ``with_data`` only affects the autogenerated downgrade (reverse);
           the ``DROP`` itself ignores it. It is forwarded to the
           :class:`DropMaterializedViewOp` so that :meth:`reverse` can
           re-create the materialized view with the original data clause.
        """
